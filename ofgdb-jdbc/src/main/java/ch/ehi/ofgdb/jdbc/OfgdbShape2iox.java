...
public class OfgdbShape2iox
{
  ...
  public OfgdbShape2iox() {
  }


  /**
   * Reads a single geometry object from a byte array.
   *
   * @param bytes the byte array to read from
   * @return the geometry read
   * @throws ParseException if parsing fails
   * @throws IoxException if the geometry cannot be converted to an IOM object
   */
  ...
  /**
   * Reads a geometry object from an {@link InStream}.
   *
