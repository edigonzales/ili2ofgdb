...
public class Config extends Settings {
    ...
    public static final String FGDB_CREATE_DOMAINS=PREFIX+".fgdbCreateDomains";
    public static final String FGDB_INCLUDE_INACTIVE_ENUM_VALUES=PREFIX+".fgdbIncludeInactiveEnumValues";
    public static final String FGDB_CREATE_RELATIONSHIP_CLASSES=PREFIX+".fgdbCreateRelationshipClasses";
    ...
    public void setFgdbCreateDomains(boolean value) {
        setValue(FGDB_CREATE_DOMAINS,value?TRUE:FALSE);
    }
    public boolean isFgdbCreateDomains() {
        return TRUE.equalsIgnoreCase(getValue(FGDB_CREATE_DOMAINS));
    }
    public void setFgdbIncludeInactiveEnumValues(boolean value) {
        setValue(FGDB_INCLUDE_INACTIVE_ENUM_VALUES,value?TRUE:FALSE);
    }
    public boolean isFgdbIncludeInactiveEnumValues() {
        return TRUE.equalsIgnoreCase(getValue(FGDB_INCLUDE_INACTIVE_ENUM_VALUES));
    }
    public void setFgdbCreateRelationshipClasses(boolean value) {
        setValue(FGDB_CREATE_RELATIONSHIP_CLASSES,value?TRUE:FALSE);
    }
    public boolean isFgdbCreateRelationshipClasses() {
        return TRUE.equalsIgnoreCase(getValue(FGDB_CREATE_RELATIONSHIP_CLASSES));
    }
