...
public interface CustomMapping {
	...
	public void fixupRoleLink(DbTable dbTable,DbColumn dbColId,AssociationDef roleOwner,RoleDef role,DbTableName targetTable,String targetPk,boolean embedded);
