// $ANTLR 2.7.7 (20060906): "ili2ofgdb/src/ch/ehi/ili2ofgdb/jdbc/parser/SqlSyntax.g" -> "SqlSyntax.java"$

	package ch.ehi.ili2ofgdb.jdbc.parser;
	import ch.ehi.ili2ofgdb.jdbc.sql.*;
	import java.util.*;
